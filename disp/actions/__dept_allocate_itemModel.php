...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    //connect to db
    require_once '../db.php';
    $sql = "INSERT INTO `dept_issue` (`item_id`, `allocate_id`,`dept_qty_issue`, `dept_issue_to`, `dept_id`, `dept_allocated_date`,`doi`) VALUES ('" . $item_id . "',' " . $allocate_id . "','" . $dept_qty_issue . "','" . $dept_issue_to . "','" . $item_current_dept_id . "'  , CURDATE() , '" . $doi . "' )";
