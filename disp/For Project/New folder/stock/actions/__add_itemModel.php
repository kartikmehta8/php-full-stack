...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    //connect to db
    require_once '../db.php';
    $sql = "INSERT INTO `item` (`item_name`, `item_cat`, `item_detail`, `bill_no`, `supplier_id`, `qty`,`cost_per`,`qty_issue`, `supplied_at`) VALUES ('" . $item_name . "',' " . $item_cat . "','" . $item_detail . "','" . $bill_no . "','" . $supplier_id . "','" . $qty . "' ,'" . $cost_per . "' ,'" . $qty . "' , '".$date_pur."')";
     //var_dump($sql);
