...
$show_dt_up_print = date("d M Y", strtotime($show_dt));
$show_dt_up_y = date("d-m-Y", strtotime('-1 days', strtotime($show_dt)));
$show_dt_up_y_print = date("d M Y", strtotime('-1 days', strtotime($show_dt)));
...
<h1 align="center"><b><u>COMN STATE AS ON &nbsp;<?php echo $show_dt_up_print; ?></u></b></h1>
...
echo '<tr>';
echo '<td align=left width=4% border=0>';
echo "1.";
echo '<td align=left><b><u>';
...
$sql_cdc = "select * from cdcbnd where doe = '".$sel_dt_up."'";
$result_cdc = $conn->query($sql_cdc);

if($result_cdc->num_rows > 0)
{

echo '<table width=96% border=1 align=right>';
echo '<tr>';
echo '<td width=4% align=left>';
echo '28.';
echo '</td>';
...
while($row_cdc = $result_web->fetch_assoc())
{
 

echo  '<tr>';
echo '<td align=center width=2%>';
echo  $row_web["dnld_spd"];
echo  '</td>';
echo '</tr>';
echo  '<tr>';
echo  '<td align=left width=20%>';
echo  $row_cdc["upld_spd"];
echo  '</td>';
echo '</tr>';
echo  '<tr>';
echo  '<td align=center width=20%>';
...
echo '28.';
echo '</td>';
echo '<td width=32% align=left><b><u>';
 echo 'Website Status';
 echo '</u><b></td>';   
...
echo '<td align=left width=4% border=0>';
echo '2.';
echo '<td colspan=9 align=left><b><u>';
 echo 'Call Throughput State';
 echo '</u><b></td>';   
  echo '</tr>';
  echo '</table>';
...
echo  '</b></td>';
echo  '</b></tr>';
$ct_dt=date('Y-m-d', strtotime('-1 days', strtotime($sel_dt_up)));
...
{
	if ($row_ct["toc"] == "In Calls" & $row_ct["doe"] == $sel_dt_up)
	{
	...
	if ($row_ct["toc"] == "Out Calls" & $row_ct["doe"] == $sel_dt_up)
	{
...
{
	if ($row_cs["toc"] == "In Calls" & $row_cs["doe"] == $sel_dt_up)
	{
...
{
	if ($row_cs["toc"] == "Out Calls" & $row_cs["doe"] == $sel_dt_up)
	{
...
echo '<td align=left><b><u>';
 ...
 echo '</u><b></td>';   
  ...
  echo '<table width=96% align=right border=0>';
...
echo '4.';
echo '</td>';
echo '<td  align=left width=32%><b><u>';
 echo 'Comn Demands';
 echo '<u><b></td>';
...
$sql_mc = "select cat, discription from move_comn_vip where cat='Move of Sr Offrs' and doe = '".$sel_dt_up."'";
...
$sql_mc = "select cat, discription from move_comn_vip where cat='Comn Arng for Sr Offr' and doe = '".$sel_dt_up."'";
$result_mc = $conn->query($sql_mc);
...
$sql_mc = "select cat, discription from move_comn_vip where cat='Move of visiting VIP' and doe = '".$sel_dt_up."'";
$result_mc = $conn->query($sql_mc);
...
$sql_mc = "select cat, discription from move_comn_vip where cat='Comn Arng of Visiting VIP' and doe = '".$sel_dt_up."'";
$result_mc = $conn->query($sql_mc);
...
echo '</td>';
echo '<td  align=left width=32%><b><u>';
 echo 'Comn Arng of Visiting VIP';
 echo '</u><b></td>';
...
echo '<td  align=center width=2%><b>';
 echo 'S No';
 echo '<b></td>'; 
 echo '<td  align=center width=7%><b>';
 echo 'Tele No';
 echo '<b></td>'; 
 echo '<td  align=center width=15%><b>';
 echo 'Name/Appt';
 echo '<b></td>';
 echo '<td  align=center width=10%><b>';
 echo 'Loc';
...
echo '</td>';
echo '<td align=left><b><u>';
 echo "Comn to Units / Sub units outside Rangapahar Mil Stn";
 echo '</u><b></td>';   
  echo '</tr>';
  echo '</table>';
...
//-----------------------------------Temporary Tele Connection/Activation/Deactivation--------------
...
echo '</td>';
echo '<td align=left><b><u>';
 echo "Temporary Tele Connection/Activation/Deactivation";
 echo '</u><b></td>';   
  echo '</tr>';
  echo '</table>';
...
echo '<td  align=center width=2%><b>';
 ...
 echo 'Loc';
 echo '<b></td>'; 
 echo '<td  align=center width=6%><b>';
 echo 'Time';
 echo '<b></td>'; 
 echo '<td  align=center width=10%><b>';
 echo 'DP Loc';
...
echo '16.';
echo '</td>';
echo '<td width=50% align=left><b><u>';
echo 'Temporary Tele Connection /Activation /Deactivation';
echo '</u><b></td>';   
echo  '<td width=50% align=left>';
echo  'Nil';
...
echo '</td>';
echo '<td align=left><b><u>';
 echo "Temporary Trunk Cct/ Activation/Deactivation";
 echo '</u><b></td>';   
  echo '</tr>';
  echo '</table>';
...
echo '17.';
echo '</td>';
echo '<td align=left width=50%><b><u>';
 echo 'Temporary Trunk Cct/ Activation/Deactivation';
 echo '</u><b></td>';   
...
echo '</td>';
echo '<td align=left><b><u>';
 echo "Damage to JFC by Digging/ construction wk/ Stolen in RMS";
 echo '</u><b></td>';   
  echo '</tr>';
  echo '</table>';
...
echo '</td>';
echo '<td align=left><b><u>';
 echo "Important Civ Tele Number";
 echo '</u><b></td>';   
  echo '</tr>';
  echo '</table>';
...
echo '</td>';
echo '<td align=left><b><u>';
 echo "State of ASIGMA in 3 Corps Z";
 echo '</u><b></td>';   
  echo '</tr>';
  echo '</table>';
...
echo '</td>';
echo '<td align=left><b><u>';
 echo "State of SERVERS in 3 Corps Z";
 echo '</u><b></td>';   
  echo '</tr>';
  echo '</table>';
...
echo '</td>';
echo '<td align=left><b><u>';
 echo "ASIGMA mailbox Creation/ Modification/ Deletion";
 echo '</u><b></td>';   
  echo '</tr>';
  echo '</table>';
...
echo '</td>';
echo '<td align=left><b><u>';
 echo "ASIGMA/LAN/ISOC Complaint";
 echo '</u><b></td>';   
  echo '</tr>';
  echo '</table>';
...
$sql_ecomp_lan = "select * from online_comp where doe = '".$sel_dt_up."' and typ_of_complaint='ADN'";
$result_ecomp_lan = $conn->query($sql_ecomp_lan);

if($result_comp_lan->num_rows > 0 || $result_ecomp_lan->num_rows > 0)
{
echo  '<tr><td colspan=7 align=center width=100%><b>';
echo "INTRANET";
echo  '</b></td></tr>';
 $i=a;
...
while($row_ecomp_lan = $result_ecomp_lan->fetch_assoc())
{
...
echo  '</td>';
echo  '<td align=left width=10%>';
echo  $row_ecomp_lan["usernm"];
echo  '</td>';
echo  '<td align=center width=5%>';
$toM=date("Hi",strtotime('+0 minutes', strtotime($row_ecomp_lan["toc"])));
$toM.=h;
echo  $toM;
echo  '</td>';
echo  '<td align=center width=5%>';
$torM= date("Hi",strtotime('+0 minutes', strtotime($row_ecomp_lan["tor"])));
$torM.=h;
echo $torM;

echo  '</td>';
echo  '<td align=left width=20%>';
echo  $row_ecomp_lan["complaint"];
echo  '</td>';

if($row_ecomp_lan["action_taken"] == "")
{
echo  "<td align=left width=20% bgcolor='#FB9C5E'>";
echo "Pending";
echo  '</td>';
}
else
{
echo  '<td align=left width=20%>';
echo  $row_ecomp_lan["action_taken"];
echo  '</td>';
}

echo  '<td align=left width=10%>';
echo  $row_ecomp_lan["remarks"];
echo  '</td>';
...
$sql_ecomp_asig = "select * from online_comp where doe = '".$sel_dt_up."' and typ_of_complaint='ASIGMA'";
$result_ecomp_asig = $conn->query($sql_ecomp_asig);

if($result_comp_asig->num_rows > 0 || $result_ecomp_asig->num_rows > 0)
{
echo  '<tr><td colspan=7 align=center width=100%><b>';
echo "ASIGMA";
echo  '</b></td></tr>';
...
while($row_ecomp_asig = $result_ecomp_asig->fetch_assoc())
{
...
echo  '</td>';
echo  '<td align=left width=10%>';
echo  $row_ecomp_asig["usernm"];
echo  '</td>';
echo  '<td align=center width=5%>';
$toM=date("Hi",strtotime('+0 minutes', strtotime($row_ecomp_asig["toc"])));
$toM.=h;
echo  $toM;
echo  '</td>';
echo  '<td align=center width=5%>';
$torM= date("Hi",strtotime('+0 minutes', strtotime($row_ecomp_asig["tor"])));
$torM.=h;
echo $torM;

echo  '</td>';
echo  '<td align=left width=20%>';
echo  $row_ecomp_asig["complaint"];
echo  '</td>';

if($row_ecomp_asig["action_taken"] == "")
{
echo  "<td align=left width=20% bgcolor='#FB9C5E'>";
echo "Pending";
echo  '</td>';
...
{
echo  '<td align=left width=20%>';
echo  $row_ecomp_asig["action_taken"];
echo  '</td>';
}

echo  '<td align=left width=10%>';
echo  $row_ecomp_asig["remarks"];
echo  '</td>';
...
$sql_ecomp_isoc = "select * from online_comp where doe = '".$sel_dt_up."' and typ_of_complaint='ISOC'";
$result_ecomp_isoc = $conn->query($sql_ecomp_isoc);

if($result_comp_isoc->num_rows > 0 || $result_ecomp_isoc->num_rows > 0)
{
echo  '<tr><td colspan=7 align=center width=100%><b>';
echo "CIVIL NET";
echo  '</b></td></tr>';
...
while($row_ecomp_isoc = $result_ecomp_isoc->fetch_assoc())
{
...
echo  '</td>';
echo  '<td align=left width=10%>';
echo  $row_ecomp_isoc["usernm"];
echo  '</td>';
echo  '<td align=center width=5%>';
$toM=date("Hi",strtotime('+0 minutes', strtotime($row_ecomp_isoc["toc"])));
$toM.=h;
echo  $toM;
echo  '</td>';
echo  '<td align=center width=5%>';
$torM= date("Hi",strtotime('+0 minutes', strtotime($row_ecomp_isoc["tor"])));
$torM.=h;
echo $torM;

echo  '</td>';
echo  '<td align=left width=20%>';
echo  $row_ecomp_isoc["complaint"];
echo  '</td>';

if($row_ecomp_isoc["action_taken"] == "")
{
echo  "<td align=left width=20% bgcolor='#FB9C5E'>";
echo "Pending";
echo  '</td>';
...
{
echo  '<td align=left width=20%>';
echo  $row_ecomp_isoc["action_taken"];
echo  '</td>';
}

echo  '<td align=left width=10%>';
echo  $row_ecomp_isoc["remarks"];
echo  '</td>';
...
echo '</td>';
echo '<td align=left><b><u>';
 echo "Sig Cen/ Crypto Center Tfc";
 echo '</u><b></td>';   
  echo '</tr>';
  echo '</table>';
...
$sql_unfd_up = "select * from unfd_adn where doe = '".$sel_dt_up."'";
$result_unfd_up = $conn->query($sql_unfd_up);

if($result_unfd_up->num_rows > 0)
{
$i=a;
echo '<table width=100% border=0>';
echo '<tr>';
...
echo '</td>';
echo '<td align=left><b><u>';
 echo "Unified ADN.</u></b> &nbsp;&nbsp;&nbsp;&nbsp; Status of onboarded PCs on unified ADN is as under :-";
 echo '</td>';   
  echo '</tr>';
  echo '</table>';
...
echo '<td align=center rowspan=2 width=2%><b>';
 echo 'S No';
 echo '<b></td>'; 
 echo '<td align=center rowspan=2 width=30%><b>';
 echo 'Fmn';
 echo '<b></td>'; 
 echo '<td align=center rowspan=2 width=10%><b>';
 echo 'Previous State';
 echo '<b></td>'; 
  echo '<td align=center colspan=2 width=10%><b>';
 echo 'Onboarded PCs <br> (last 24 Hrs)';
 echo '<b></td>'; 
...
while($row_unfd_up = $result_unfd_up->fetch_assoc())
{
...
echo  '</td>';
echo  '<td align=left width=30%>';
echo  $row_unfd_up["fmn"];
echo  '</td>';
echo  '<td align=center width=10%>';
echo  $row_unfd_up["pr_stat"];
echo  '</td>';
echo  '<td align=center width=10%>';
echo  $row_unfd_up["unit_lan"];
echo  '</td>';
echo  '<td align=center width=20%>';
echo  $row_unfd_up["standaln"];
echo  '</td>';
echo  '<td align=center width=20%>';
echo  $row_unfd_up["p_stat"];
echo  '</td></tr>';
...
echo '31.';
echo '</td>';
echo '<td align=left width=50%><u><b>';
echo 'Unified ADN.</u></b>&nbsp;&nbsp;&nbsp;&nbsp; Status of onboarded OCS on unified ADN is as under :-';
echo '<b></td>';   
echo  '<td width=50% align=left>';
echo  'Nil';
echo  '</td>';
...
$sql_rat_up = "select * from rat where doe = '".$sel_dt_up."'";
$result_rat_up = $conn->query($sql_rat_up);

if($result_rat_up->num_rows > 0)
{
$i=a;
echo '<table width=100% border=0>';
echo '<tr>';
...
echo '32.';
echo '</td>';
echo '<td align=left><u><b>';
 echo "RAT.</u></b> &nbsp;&nbsp;&nbsp;&nbsp; State of Remote Audit Tool impl is as under:-";
 echo '<b></td>';   
  echo '</tr>';
  echo '</table>';
...
echo '<td align=center rowspan=2 width=2%><b>';
 echo 'S No';
 echo '<b></td>'; 
 echo '<td align=center rowspan=2width=30%><b>';
 echo 'Fmn';
 echo '<b></td>'; 
 echo '<td align=center rowspan=2 width=10%><b>';
 echo 'Server installed <br> (Yes/No)';
 echo '<b></td>'; 
  echo '<td align=center colspan=2 width=10%><b>';
 echo 'Client Module Installed';
 echo '<b></td>'; 
 echo '<td align=center rowspan=2 width=20%><b>';
 echo 'Present State';
 echo '<b></td></tr>';
...
echo  '<tr bgcolor=lightgrey>';
echo  '<td align=center bgcolor=lightgrey width=20%><b>';
echo  "ADN";
echo  '</b></td>';
echo  '<td align=center bgcolor=lightgrey width=20%><b>';
echo  "LAN/ SA";
...
while($row_rat_up = $result_rat_up->fetch_assoc())
{
...
echo  '</td>';
echo  '<td align=center width=10%>';
echo  $row_rat_up["server_int"];
echo  '</td>';
echo  '<td align=center width=10%>';
echo  $row_rat_up["adn_client"];
echo  '</td>';
echo  '<td align=center width=20%>';
echo  $row_rat_up["sa_client"];
echo  '</td>';
echo  '<td align=center width=20%>';
echo  $row_rat_up["total"];
echo  '</td></tr>';
...
echo '</td>';
echo '<td align=left width=50%><u><b>';
echo 'RAT.</b></u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; State of Remote Audit Tool impl is as under :-';
echo '</td>';   
echo  '<td width=50% align=left>';
echo  'Nil';
echo  '</td>';
...
//----------------------------------------------Call State – welfare-----------------------------------
$sql_ia = "select * from welfare where doe = '".$sel_dt_up."'";
$result_ia = $conn->query($sql_ia);
$temp=0;
if($result_ia->num_rows > 0)
{
...
echo  '</td>';
echo  '<td align=center width=10%>';
echo  $row_ia["name_of_post"];
echo  '</td>';
echo  '<td align=center width=10%>';
echo  $row_ia["booked_no"];
echo  '</td>';
echo  '<td align=left width=10%>';
echo  $row_ia["booked_loc"];
echo  '</td>';
echo  '<td align=left width=10%>';
echo  $row_ia["tob"];
echo  '</td>';
...
echo '<tr>';
echo  '<td colspan=6 align=center width=40%><b>';
echo  "Total";
echo  '</b></td>';
echo  '<td colspan=6 align=center width=40%><b>';
echo  $temp;
...
echo '<td width=32% align=left><b><u>';
 echo "Trunk cct and Satl Assets state"; 
 echo '</u></b></td>';
 echo '<td width=50% align=left >';
 echo "Detls are as att at Annx I and Annx II.";
 echo '</td>';
  echo '</tr>';
  echo "</table>";
...
<h1 align="center"><b><u>NR SHEET VIP CALLS AS ON &nbsp;<?php echo $show_dt_up_y_print; ?></u></b></h1>
<?php

//----------------------------------------------Call State – VIP NR-----------------------------------
$sql_ianr = "select * from nr_sheet where doe = '".$sel_dt_up."'";
$result_ianr = $conn->query($sql_ianr);
$temp=0;
if($result_ianr->num_rows > 0)
{
  echo '<table width=100% border=1 bgcolor=white>';
echo '<tr bgcolor=lightgrey>';
echo '<td  align=center rowspan=2 width=7%><b>';
 echo 'From';
 echo '<b></td>';
echo '<td  align=center rowspan=2 width=20%><b>';
 echo 'Appt';
 echo '<b></td>'; 
 echo '<td  align=center rowspan=2 width=8%><b>';
 echo 'Type of Call';
 echo '<b></td>'; 
 echo '<td  align=center rowspan=2 width=6%><b>';
 echo 'Call To';
 echo '<b></td>';
 echo '<td  align=center rowspan=2 width=20%><b>';
 echo 'Appt';
 ...
 echo 'Tele No';
 echo '<b></td>'; 
 echo '<td  align=center colspan=2 width=14%><b>';
 echo 'Time';
 echo '<b></td>'; 
...
echo  '<td align=center bgcolor=lightgrey width=5%><b>';
echo  "Booking";
echo  '</b></td>';
echo  '<td align=center bgcolor=lightgrey width=5%><b>';
echo  "Connect";
...
//-------GOC OUT Calls----------------  
$sql_nr_f = "select * from toc_nr_sheet order by id";
$result_nr_f = $conn->query($sql_nr_f);

if($result_nr_f->num_rows > 0)
{

  
while($row_nr_f = $result_nr_f->fetch_assoc())

{

echo  '<tr><td align=left colspan=12 width=7%><b>';
echo  $row_nr_f["toc"];
echo  '</b></td></tr>'; 
 $sql_nr_sh = "select * from nr_sheet where toc='".$row_nr_f["toc"]."' and doe = '".$sel_dt_up."'";
$result_nr_sh = $conn->query($sql_nr_sh);

if($result_nr_sh->num_rows > 0)
{
  
while($row_nr_sh = $result_nr_sh->fetch_assoc())

{
 
  
echo  '<tr><td align=left width=7%>';
echo  $row_nr_sh["call_fm"];
echo  '</td>';

echo  '<td align=left width=20%>';
echo  $row_nr_sh["appt_fm"];

echo  '</td>';
echo  '<td align=center width=8%>';
echo  $row_nr_sh ["no_fm"];
echo  '</td>';
echo  '<td align=left width=6%>';
echo  $row_nr_sh["call_to"];

echo  '</td>';
echo  '<td align=left width=20%>';
echo  $row_nr_sh["appt_to"];
echo  '</td>';
echo  '<td align=center width=10%>';
echo  $row_nr_sh["no_to"];
echo  '</td>';
echo  '<td align=center width=7%>';
if($row_nr_sh["booking"] == "")
{
echo "-";
}
else
{
$toB=date("H:i",strtotime('+0 minutes', strtotime($row_nr_sh["booking"])));
$toB.=h;
echo  $toB;
}
echo  '</td>';
echo  '<td align=center width=7%>';
$toCC=date("H:i",strtotime('+0 minutes', strtotime($row_nr_sh["cont"])));
$toCC.=h;
echo  $toCC;
echo  '</td>';
...
echo  $row_nr_sh["dur"];
echo  '</td>';
echo  '<td align=left width=8%>';
echo  $row_nr_sh["media"];
echo  '</td>';
echo  '<td align=left width=6%>';
echo  $row_nr_sh["ntsm"];
echo  '</td>';
echo  '<td align=left width=10%>';
echo  $row_nr_sh["remarks"];
echo  '</td>';
echo  '</tr>';
}
