...
echo '<table width=100% border=0>';
echo '<tr>';
echo '<td align=left width=30%><b><u>';
 echo '13. Shifting of Tele';
 echo '</u><b></td>';   
...
echo '<tr>';
echo '<td align=left><b><u>';
 echo "31. Call State: Welfare Desk";
 echo '</u><b></td>';   
  echo '</tr>';
  echo "</table>";
...
echo '<tr>';
echo '<td align=left><b><u>';
 echo "32. Trunk cct and Satl Assets state	:</u></b>      Detls are as att at Annx I and Annx II";
 echo '</td>';   
  echo '</tr>';
  echo "</table>";
?>
<p style='page-break-after:always'></p>
<h1 align="center"><b><u>NR SHEET VIP CALLS AS ON &nbsp;<?php echo $show_dt_up_y; ?></u></b></h1>
<?php
...
echo '<tr>';
echo  '<td colspan=12 align=left><b>';
echo  'Nil';
echo  '<b></td></tr>';
