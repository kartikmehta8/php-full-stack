...
<!-- Edit -->
<div class="modal fade" id="edit_<?php echo $row['allocate_id']; ?>" tabindex="-1" role="dialog"
     aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form method="POST" action="./actions/__dept_edit_itemModel.php">
                        <input type="hidden" class="form-control" name="allocate_id" value="<?php echo $row['allocate_id']; ?>">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="item_detail"
                                       value="<?php echo $row['item_detail']; ?>" readonly>
                                       
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-sm-2">
                                <label class="control-label modal-label">LP No:</label>
                            </div>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="lp_no"
                                       value="<?php echo $row['lp_no']; ?>" >
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-sm-2">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="allocate_qty"
						 ...
						 <div class="row form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="cost_per"
                                       value="<?php echo $row['cost_per']; ?>" readonly>
                                <?php //$conn->close();?>
                            </div>
                        </div>
...
<div class="modal fade" id="delete_<?php echo $row['allocate_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
