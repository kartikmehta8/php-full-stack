...
<div class="modal fade" id="qrcode_<?php echo $row['allocate_id']; ?>" tabindex="-1" role="dialog"
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <form method="POST" action="./lib/qr/index.php">
                        <input type="hidden" class="form-control" name="item_id" value="<?php echo $row['allocate_id']; ?>">
...
<div class="modal fade" id="return_<?php echo $row['allocate_id']; ?>" tabindex="-1" role="dialog"
     aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <form method="POST" action="./lib/qr/index.php">
                        ...
                        <div class="row form-group">
                            <div class="col-sm-2">
                                <label class="control-label modal-label">Qty In Store:</label>
                            </div>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="vendor"
                                       value="<?php echo $row['supplier_id']; ?>" readonly>
