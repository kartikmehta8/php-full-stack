...
<?php
            ...
            $temp++;
                ...
                $q = "SELECT * FROM allocate INNER JOIN item ON allocate.item_id=item.item_id where allocate.dept_id='96' ";
 ...
 $q = "SELECT * FROM allocate INNER JOIN item ON allocate.item_id=item.item_id where allocate.dept_id='97' ";
 ...
 $q = "SELECT * FROM allocate INNER JOIN item ON allocate.item_id=item.item_id where allocate.dept_id='98' ";
 ...
 $q = "SELECT * FROM allocate INNER JOIN item ON allocate.item_id=item.item_id where allocate.dept_id='99' ";
